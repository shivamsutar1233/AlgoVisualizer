...
export const TreeVisualizer: React.FC = () => {
    ...
    const insertNode = (currentNode: TreeNode | null, value: number): TreeNode => {
        if (!currentNode) {
    ...
    const searchNode = async (currentNode: TreeNode | null, value: number): Promise<boolean> => {
        if (!currentNode) {
    ...
    const deleteNode = (currentNode: TreeNode | null, value: number): TreeNode | null => {
        if (!currentNode) {
            return null;
        }
            ...
            if (operation === 'traverse') {
                ...
                switch (operation) {
                    case 'insert':
                        ...
                        break;
                    case 'delete':
                        setRoot(prev => prev ? deleteNode({ ...prev }, numValue) : null);
                        break;
                    case 'search':
